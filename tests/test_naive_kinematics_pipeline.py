...
class NaiveKinematicsPipelineTest(unittest.TestCase):
    def test_builds_artifact_paths_for_sensor(self) -> None:
        from scripts.totalcapture_test.naive_kinematics.run_pipeline import build_sensor_artifact_paths

        paths = build_sensor_artifact_paths(
            repo_root=Path("/repo"),
            data_root=Path("/repo/data"),
            output_root=Path("/repo/outputs/totalcapture_test/naive_kinematics"),
        ...
        self.assertEqual(
            ...
            Path("/repo/outputs/totalcapture_test/naive_kinematics/csv/R_LowArm_generated.csv"),
        )
        self.assertEqual(
            paths["plot_png"],
            Path("/repo/outputs/totalcapture_test/naive_kinematics/plots/R_LowArm_raw_vs_generated.png"),
        )

    def test_report_supports_single_r_lowarm_sensor(self) -> None:
        from scripts.totalcapture_test.naive_kinematics.run_pipeline import build_report
        ...
        self.assertIn("naive_kinematics", report)
